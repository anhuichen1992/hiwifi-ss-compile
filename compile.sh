...
ver=1.0.16
wget --no-check-certificate https://download.libsodium.org/libsodium/releases/old/libsodium-$ver.tar.gz
...
wget https://sources.voidlinux.org/libev-$ver/libev-$ver.tar.gz
